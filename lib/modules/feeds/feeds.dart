            ...
            children: [
              ...
              Expanded(
                ...
                onFieldSubmitted: (value) {
                  print('onsubmitt');
                  SocialCubit.get(ctx).createNewComment(commentController.text,
          ...
          Expanded(
            child: Conditional.single(
              ...
              conditionBuilder: (ctx) =>
                  SocialCubit.get(ctx).comments.length > 0,
              // true,
                ...
                return ListView.separated(
                  ...
                  itemBuilder: (ctx, index) {
                    return buildCommentItem(
                        SocialCubit.get(ctx).comments[index], ctx);
                  },
                  separatorBuilder: (ctx, index) =>
                      Container(height: 1, width: double.infinity),
                  itemCount: SocialCubit.get(ctx).comments.length,
                );
              },
              fallbackBuilder: (ctx) => Center(
...
Widget buildCommentItem(CommentsModel commentsModel, ctx) {
  return Row(children: [
    CircleAvatar(
      radius: 16,
      backgroundImage: NetworkImage('${SocialCubit.get(ctx).model?.image}'),
      /*'https://as1.ftcdn.net/v2/jpg/02/96/20/94/1000_F_296209436_rSsK1SYwSv1NuKVxQXF0aAht2iDSyocf.jpg'),*/
    ),
    SizedBox(
      width: 15,
